...
from examples.dds.stg_dds_users_dag.users_loader import UserLoader
...
def sprint5_example_dds_from_stg_users_dag():
...
dds_users_dag = sprint5_example_dds_from_stg_users_dag()
